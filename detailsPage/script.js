...
let data = {
  ...
  favorite: true,
  name: "Old Fashioned",
  props: ["iba", "classic", "alcoholic", "expensive", "savory"],
};
...
function loadDetailsPage() {
  ...
  textInstructions.textContent = countries[0].text; // adaugare provizorie.
